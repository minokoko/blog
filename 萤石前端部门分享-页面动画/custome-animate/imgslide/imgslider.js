...
;(function(factory) {
     ...
     *  图片容器:idPrefix+'img',导航容器：idPrefix+'nav'
    ...
    function ImgSlider(config) {
        var defaults = {
            ...
            callback:function(curimg,preimg){}
        };
        var that = this;
    ...
    /**
     * 渐变效果实现
     * @param  {object} $preimg 滑动DOM
     * @param  {object} $curimg 滑动DOM
     */
    ...
    /**
     * 3d翻滚效果实现
     * @param  {num} nowIndex  当前图片索引
     * @param  {num} nextIndex 下张图片索引
     */
